...
<div class="container-fluid">
	<div class="row-fluid">
		<div class="main" style="height:360px;overflow:hidden;">
			<div class="col-xs-2 box itembox" style="width:22%;height:360px;overflow:hidden;">
	...
	<div class="row-fluid">
		...
		<!-- 	<div class="col-xs-3" style="padding:0px;">
			...
			<div class="col-xs-12" style="padding-left:0px;">
				...
				<div class="col-xs-3">
					<a style="height:256px;overflow:hidden" href="index.php?course-app-course&csid={x2;v:course['csid']}" class="thumbnail">
						<img src="{x2;v:course['csthumb']}" alt="" style="overflow:hidden">
					</a>
