	...
	<div class="row-fluid">
		<div class="main box itembox">
			...
			<div class="col-xs-12" style="padding-left:0px;">
				...
				<div class="col-xs-3">
					<a style="height:256px;overflow:hidden" href="index.php?course-app-course&csid={x2;v:content['csid']}" class="thumbnail">
						<img src="{x2;v:content['csthumb']}" alt="" style="overflow:hidden">
					</a>
