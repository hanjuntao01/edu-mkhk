...
{x2;endif}
				...
				<div class="box itembox" style="padding-top:10px;margin-bottom:0px;">
					<h4 class="title" style="padding:10px;">证书管理</h4>
			        ...
			        <table class="table table-hover table-bordered">
			            ...
			            <tbody>
					        ...
					        <tr>
								...
								<td><a class="btn btn-primary" href="index.php?exam-teach-users-honordetail&userid={x2;v:exam['ehuserid']}&ehscore={x2;v:exam['ehscore']}" target="_blank">查看证书</a></td>
					        </tr>
					        {x2;endtree}
			        	</tbody>
			        </table>
