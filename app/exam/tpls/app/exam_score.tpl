		...
		<div class="main">
			...
			<div class="box itembox">
            	...
            	<div class="col-xs-8">
                   ...
                   <div class="text-center"><a href="index.php?course-app-course&csid=2&contentid={x2;$examlevel2}" class="btn btn-info">返回课程继续学习</a></div>
                  {x2;endif}
                   <!-- 
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div id="lessonknows">本次考试通过考核，6秒后自动进入下一章课程！</div>
      </div>
...
$(function(){
  ...
  //判断考试分数是否大于90分 $sessionvars['examsessionsetting']['examsetting']['passscore']
