<div class="container-fluid box" style="margin:0px auto;padding-top:10px; background: white;">
	<div class="row-fluid">
		<div class="main">
			<div class="col-xs-3">
			...
			<div class="col-xs-6" style="padding-top:22px;">
				<div class="form-inline">
					...
					<!--<button type="button" class="btn btn-primary" onclick="javascript:window.location='index.php?content-app-search&keyword='+$('#keyword').val();">搜资料</button>-->
