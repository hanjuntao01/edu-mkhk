			...
			<div class="col-xs-5 pull-right" style="padding-right:0px;" id="userlevel" userlevel="{x2;$userlevel}">
					...
					<div class="col-xs-4 box_" style="padding-left:0px;position:relative; overflow: auto;">
						...
						<div class="box itembox" style="width:153px;height: 30px;background: #337AB7;">				
							<a action-before="clearStorage" href="index.php?exam-app-exam-selectquestions&examid={x2;$content['course_examid']}" class="thumbnail ajax herf" style="position:relative;background: #337AB7;color:white; none;border: 0;" id="herf"><center>Start Test</center></a>
						</div>
					{x2;endif}
