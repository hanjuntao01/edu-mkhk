					...
					<h4 class="title" style="padding:10px;">
						...
						<span class="dropdown pull-right">
							...
							<ul class="dropdown-menu">
								<li><a href="index.php?{x2;$_app}-master-category-add&parent={x2;$parent}">Add category</a></li>
							<!-- 	<li><a href="index.php?{x2;$_app}-master-category&parent={x2;$categories[$parent]['catparent']}">上级分类</a></li> -->
		                    </ul>
						</span>
					</h4>
					<h4>{x2;if:$parent}{x2;$categories[$parent]['catname']}{x2;else}Top Category{x2;endif}</h4>
