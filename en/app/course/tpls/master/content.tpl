...
{x2;endif}
				<div class="box itembox" style="margin-bottom:0px;border-bottom:1px solid #CCCCCC;">
					<div class="col-xs-12">
						<ol class="breadcrumb">
							...
							{x2;if:$catid}
							<li><a href="index.php?{x2;$_app}-master-contents">Courseware management</a></li>
				...
				<div class="box itembox" style="padding-top:10px;margin-bottom:0px;">
					<h4 class="title" style="padding:10px;">
						...
						<a class="btn btn-primary pull-right" href="index.php?course-master-contents-add&courseid={x2;$course['csid']}&page={x2;$page}">Add courseware</a>
					</h4>
					<h4>{x2;if:$course}{x2;$course['cstitle']}{x2;else}All courseware{x2;endif}</h4>
