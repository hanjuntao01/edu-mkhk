...
{x2;endif}
				...
				<div class="box itembox" style="padding-top:10px;margin-bottom:0px;">
					<h4 class="title" style="padding:10px;">
						Modify courseware
						<a class="btn btn-primary pull-right" href="index.php?{x2;$_app}-master-contents&courseid={x2;$content['coursecsid']}&page={x2;$page}">Courseware management</a>
					</h4>
					<form action="index.php?course-master-contents-edit" method="post" class="form-horizontal">
						<div class="form-group">
				            ...
				            <div class="col-sm-9">
							    <input class="form-control" type="text" id="coursetitle" name="args[coursetitle]" needle="needle" msg="You must enter a title" value="{x2;$content['coursetitle']}">
					        </div>
				        </div>
				        <div class="form-group">
						    		...
						    		<div class="qq-uploader-selector" style="width:30%" qq-drop-area-text="Drag the picture to upload here" style="clear:both;">
						            	<div class="qq-upload-button-selector" style="clear:both;">
								            ...
								            <ul class="qq-upload-list-selector list-unstyled" aria-live="polite" aria-relevant="additions removals" style="clear:both;">
									            <li class="text-center">
									                <div class="thumbnail">
														<img class="qq-thumbnail-selector" src="{x2;$content['coursethumb']}" alt="Click to upload a new picture">
