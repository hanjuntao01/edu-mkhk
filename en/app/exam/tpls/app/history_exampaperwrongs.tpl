			...
			<div class="box itembox">
				<div class="col-xs-12">
					<ol class="breadcrumb">
					  ...
					  <li><a href="index.php?exam-app-history">Exam Records</a></li>
					  <li class="active">Check error</li>
					</ol>
				</div>
			</div>
		</div>
			...
			<div class="col-xs-12" style="padding:0px;position:relative;">
				...
				<div class="box itembox paperexamcontent">
					...
					<div class="decidediv" style="position:relative;">
	                	...
	                	<table class="table table-hover table-bordered">
            				<tr class="info">
	                			<th colspan="2" style="border-top:0px;">Score：{x2;$sessionvars['examsessionscorelist'][v:question['questionid']]}marks{x2;if:$sessionvars['examsessiontimelist'][v:question['questionid']]} &nbsp;&nbsp;Use time：{x2;date:$sessionvars['examsessiontimelist'][v:question['questionid']],'Y-m-d H:i:s'}{x2;endif}</th>
	                		</tr>
	                		<tr>
	                    		<td width="15%">Right key：</td>
				...
				<div class="box itembox paperexamcontent">
					...
					<div class="decidediv" style="position:relative;">
	                	...
	                	<table class="table table-hover table-bordered">
            				<tr class="info">
	                			<th colspan="2" style="border-top:0px;">Score：{x2;$sessionvars['examsessionscorelist'][v:data['questionid']]}marks{x2;if:$sessionvars['examsessiontimelist'][v:data['questionid']]} &nbsp;&nbsp;Use time：{x2;date:$sessionvars['examsessiontimelist'][v:data['questionid']],'Y-m-d H:i:s'}{x2;endif}</th>
	                		</tr>
	                		<tr>
	                    		<td width="15%">Right key：</td>
