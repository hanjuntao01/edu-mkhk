		...
		<div class="main">
			...
			<div class="col-xs-2" style="padding-top:22px;">
				<ul class="list-unstyled list-inline">
					...
					<li>
						<div class="btn-group">
							<button type="button" class="btn btn-primary"><em class="glyphicon glyphicon-user"></em> {x2;$_user['username']}</button>
							...
							<ul class="dropdown-menu">
								...
								{x2;if:$_user['teacher_subjects']}<li><a href="index.php?exam-teach"><em class="glyphicon glyphicon-book"></em> Teacher management</a></li>{x2;endif}
								{x2;if:$_user['groupid'] == 1}<li><a href="index.php?core-master"><em class="glyphicon glyphicon-dashboard"></em> Admin</a></li>{x2;endif}
