		...
		<div class="main box">
			...
			<form id="form1" name="form1" method="post" action="index.php?exam-app-exam-score" class="col-xs-9 split pull-right" style="padding:0px;">
				...
				<div class="box itembox paperexamcontent" id="questions_{x2;v:question['questionid']}" rel="{x2;v:quest}">
					...
					<div class="toolbar">
						{x2;if:v:qcid > 1}
						<a class="btn btn-default" onclick="javascript:gotoindexquestion({x2;eval: echo v:qcid - 2;});"><span class="glyphicon glyphicon-chevron-left"></span>Previous question</a>
						{x2;endif}
						{x2;if:v:qcid < v:qmid}
						<a class="pull-right btn btn-primary" onclick="javascript:gotoindexquestion({x2;v:qcid});">Next question<span class="glyphicon glyphicon-chevron-right"></span></a>
						{x2;endif}
					</div>
				</div>
				{x2;endtree}
				...
				<div class="box itembox paperexamcontent" id="questions_{x2;v:data['questionid']}" rel="{x2;v:quest}">
					<h4 class="title">the {x2;v:tid} Questions</h4>
					<div class="choice">
