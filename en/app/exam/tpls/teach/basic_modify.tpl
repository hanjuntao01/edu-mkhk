...
{x2;endif}
				<div class="box itembox" style="margin-bottom:0px;border-bottom:1px solid #CCCCCC;">
					<div class="col-xs-12">
						<ol class="breadcrumb">
							...
							<li><a href="index.php?{x2;$_app}-teach-basic">Examination room management</a></li>
				...
				<div class="box itembox" style="padding-top:10px;margin-bottom:0px;">
					<h4 class="title" style="padding:10px;">
						Modify
						<a class="btn btn-primary pull-right" href="index.php?exam-teach-basic&page={x2;$page}{x2;$u}">Examination room management</a>
					</h4>
		        	<form action="index.php?exam-teach-basic-modifybasic" method="post" class="form-horizontal">
						<fieldset>
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input class="form-control" id="basic" name="args[basic]" type="text" value="{x2;$basic['basic']}" needle="needle" msg="You must enter the name of the examination room." />
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-9">
									<label class="radio-inline">
										<input name="args[basicclosed]" type="radio" value="0" {x2;if:!$basic['basicclosed']}checked{x2;endif}/>Open
									</label>
									<label class="radio-inline">
										<input name="args[basicclosed]" type="radio" value="1" {x2;if:$basic['basicclosed']}checked{x2;endif}/>Close
									</label>
								</div>
							</div>
							<div class="form-group">
							    		...
							    		<div class="qq-uploader-selector" style="width:30%" qq-drop-area-text="Drag the picture to upload here" style="clear:both;">
							            	<div class="qq-upload-button-selector" style="clear:both;">
									            ...
									            <ul class="qq-upload-list-selector list-unstyled" aria-live="polite" aria-relevant="additions removals" style="clear:both;">
										            <li class="text-center">
										                <div class="thumbnail">
															<img class="qq-thumbnail-selector" src="{x2;$basic['basicthumb']}" alt="Click to upload a new picture">
