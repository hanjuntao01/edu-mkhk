				...
				<table class="table table-hover table-bordered">
					<thead>
						<tr class="info">
					        ...
					        <th width="100">Questions type</th>
					        <th>Questions content</th>
					        <th width="50">degree of difficulty</th>
						</tr>
					</thead>
					<tbody>
						{x2;tree:$questions['data'],question,qid}
				        <tr>
						  ...
						  <td>{x2;if:v:question['questionlevel']==2}indifferent{x2;elseif:v:question['questionlevel']==3}difficult{x2;elseif:v:question['questionlevel']==1}easily{x2;endif}</td>
				        </tr>
				        {x2;endtree}
					</tbody>
				</table>
