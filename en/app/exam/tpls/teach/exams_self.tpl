				...
				<div class="box itembox" style="margin-bottom:0px;border-bottom:1px solid #CCCCCC;">
					<div class="col-xs-12">
						<ol class="breadcrumb">
							...
							<li><a href="index.php?{x2;$_app}-teach-exams&page={x2;$page}{x2;$u}">Papers management</a></li>
			        ...
			        <form action="index.php?exam-teach-exams-selfpage" method="post" class="form-horizontal">
						...
						<div class="form-group questpanel panel_{x2;v:questype['questid']}">
							...
							<div class="col-sm-9 form-inline">
								...
								<span class="info">&nbsp;<a class="selfmodal btn btn-primary" href="javascript:;" data-target="#modal" url="index.php?exam-teach-exams-selectquestions&search[questionsubjectid]={selectedsubjectid}&search[questiontype]={x2;v:key}&questionids={iselectquestions_{x2;v:key}}&rowsquestionids={iselectrowsquestions_{x2;v:key}}&useframe=1" valuefrom="iselectquestions_{x2;v:key}|iselectrowsquestions_{x2;v:key}|selectedsubjectid">Select questions</a></span>
