					...
					<h4 class="title" style="padding:10px;">
						...
						<span class="pull-right">
							...
							<ul class="dropdown-menu">
								...
								<li><a href="index.php?{x2;$_app}-master-exams-selfpage&page={x2;$page}{x2;$u}">Manual test paper</a></li>
					        ...
					        <tr>
								...
								<td>
									<div class="btn-group">
			                    		...
			                    		<a class="btn" target="_blank" href="index.php?{x2;$_app}-master-exams-preview&examid={x2;v:exam['examid']}{x2;$u}" title="Check the papers"><em class="glyphicon glyphicon-list-alt"></em></a>
			                    		{x2;endif}
			                    		{x2;if:v:exam['examtype'] == 3}
			                    		<a class="btn ajax" href="index.php?{x2;$_app}-master-exams-outcsv&page={x2;$page}&examid={x2;v:exam['examid']}{x2;$u}" title="Download csv"><em class="glyphicon glyphicon-download-alt"></em></a>
			                    		{x2;endif}
			                    		<a class="btn" href="index.php?{x2;$_app}-master-exams-modify&page={x2;$page}&examid={x2;v:exam['examid']}{x2;$u}" title="Modify"><em class="glyphicon glyphicon-edit"></em></a>
										<a class="btn confirm" href="index.php?{x2;$_app}-master-exams-del&page={x2;$page}&examid={x2;v:exam['examid']}{x2;$u}" title="Delete"><em class="glyphicon glyphicon-remove"></em></a>
			                    	</div>
								</td>
					        </tr>
					        {x2;endtree}
