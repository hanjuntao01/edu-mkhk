...
{x2;endif}
				<div class="box itembox" style="margin-bottom:0px;border-bottom:1px solid #CCCCCC;">
					<div class="col-xs-12">
						<ol class="breadcrumb">
							...
							<li><a href="index.php?{x2;$_app}-master-basic">Exam room management</a></li>
							<li class="active">Add exam room</li>
						</ol>
					</div>
				</div>
				<div class="box itembox" style="padding-top:10px;margin-bottom:0px;">
					<h4 class="title" style="padding:10px;">
						Add exam room
						<a class="btn btn-primary pull-right" href="index.php?exam-master-basic">Exam room management</a>
					</h4>
