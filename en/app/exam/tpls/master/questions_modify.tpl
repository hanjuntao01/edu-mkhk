				...
				<div class="box itembox" style="margin-bottom:0px;border-bottom:1px solid #CCCCCC;">
					<div class="col-xs-12">
						<ol class="breadcrumb">
							...
							<li><a href="index.php?{x2;$_app}-master-questions&page={x2;$page}{x2;$u}">General questions management</a></li>
							<li class="active">Modify General questions</li>
						</ol>
					</div>
				</div>
				<div class="box itembox" style="padding-top:10px;margin-bottom:0px;">
					<h4 class="title" style="padding:10px;">
						Modify General questions
						<a class="btn btn-primary pull-right" href="index.php?{x2;$_app}-master-questions&page={x2;$page}{x2;$u}">General questions management</a>
					</h4>
					<form action="index.php?exam-master-questions-modifyquestion" method="post" class="form-horizontal">
						...
						<div class="form-group">
							<label class="control-label col-sm-2">Knowledge point：</label>
						  	<div class="col-sm-9">
						  		<textarea class="form-control" rows="4" needle="needle" min="1" msg="You need at least one point of knowledge" name="args[questionknowsid]" id="questionknowsid" readonly>{x2;tree:$question['questionknowsid'],know,kid}{x2;v:know['knowsid']}:{x2;v:know['knows']}{x2;enter}{x2;endif}</textarea>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
					  		<label class="control-label col-sm-2"></label>
					  		<div class="col-sm-9">
					  			<input type="button" class="btn btn-primary" value="Selectd" onclick="javascript:setKnowsList('questionknowsid','iknowsselect','+');"/>
						...
						<div class="form-group">
							<label class="control-label col-sm-2">Question type：</label>
						  	<div class="col-sm-3">
							  	<select needle="needle" msg="You must select a topic as to add the item." name="args[questiontype]" class="combox form-control" onchange="javascript:setAnswerHtml($(this).find('option:selected').attr('rel'),'answerbox');">
						...
						<div class="form-group" id="selectnumber"{x2;if:$questypes[$question['questiontype']]['questsort'] || $questypes[$question['questiontype']]['questchoice'] == 5} style="display:none;"{x2;endif}>
							<label for="questionselectnumber" class="control-label col-sm-2">Number of options：</label>
						  	<div class="col-sm-3">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								...
								<div id="answerbox_4" class="col-sm-9"{x2;if:$questypes[$question['questiontype']]['questchoice'] != 4} style="display:none;"{x2;endif}>
								  	<label class="radio-inline"><input type="radio" name="targs[questionanswer4]" value="A"{x2;if:$question['questionanswer'] == 'A'} checked{x2;endif}>right</label>
								  	<label class="radio-inline"><input type="radio" name="targs[questionanswer4]" value="B"{x2;if:$question['questionanswer'] == 'B'} checked{x2;endif}>error</label>
								</div>
