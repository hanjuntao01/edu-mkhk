				...
				<div class="box itembox" style="margin-bottom:0px;border-bottom:1px solid #CCCCCC;">
					<div class="col-xs-12">
						<ol class="breadcrumb">
							...
							<li class="active">Modify subject</li>
						</ol>
					</div>
				</div>
			        ...
			        <form action="index.php?exam-master-basic-modifysubject" method="post" class="form-horizontal">
						<fieldset>
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input class="form-control" name="args[subject]" id="subject" type="text" size="30" value="{x2;$subject['subject']}" needle="needle" msg="You must enter a name for the subject" />
								</div>
							</div>
							<div class="form-group">
