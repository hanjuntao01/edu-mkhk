				...
				<div class="box itembox" style="margin-bottom:0px;border-bottom:1px solid #CCCCCC;">
					<div class="col-xs-12">
						<ol class="breadcrumb">
							...
							<li class="active">Modify question type</li>
						</ol>
					</div>
				</div>
				<div class="box itembox" style="padding-top:10px;margin-bottom:0px;">
			        ...
			        <form action="index.php?exam-master-basic-modifyquestype" method="post" class="form-horizontal">
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input class="form-control" name="args[questype]" id="questype" type="text" size="30" value="{x2;$quest['questype']}" class="required" alt="Please enter the item name" />
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-4">
								<select class="form-control combox" id="questsort" name="args[questsort]" onchange="javascript:if($(this).val() == '1')$('#choicebox').hide();else $('#choicebox').show();">
									<option value="1"{x2;if:$quest['questsort']} selected{x2;endif}>Subjective</option>
		  							<option value="0"{x2;if:!$quest['questsort']} selected{x2;endif}>Objective</option>
								</select>
							</div>
						</div>
