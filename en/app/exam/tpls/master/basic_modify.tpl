				...
				<div class="box itembox" style="margin-bottom:0px;border-bottom:1px solid #CCCCCC;">
					<div class="col-xs-12">
						<ol class="breadcrumb">
							...
							<li><a href="index.php?{x2;$_app}-master-basic">Examination room management</a></li>
							<li class="active">Modify examination room</li>
						</ol>
					</div>
				</div>
				<div class="box itembox" style="padding-top:10px;margin-bottom:0px;">
					<h4 class="title" style="padding:10px;">
						Modify examination room
						<a class="btn btn-primary pull-right" href="index.php?exam-master-basic&page={x2;$page}{x2;$u}">Examination room management</a>
					</h4>
		        	<form action="index.php?exam-master-basic-modifybasic" method="post" class="form-horizontal">
						<fieldset>
							<div class="form-group">
								<label for="basic" class="control-label col-sm-2">Exam room name</label>
								<div class="col-sm-4">
							...
							<div class="form-group">
								<label class="control-label col-sm-2">Exam room status</label>
								<div class="col-sm-9">
							...
							<div class="form-group">
								<label for="basicthumb" class="control-label col-sm-2">Thumbnail</label>
								<div class="col-sm-9">
							...
							<div class="form-group">
								<label for="basicsubjectid" class="control-label col-sm-2">Exam subjects</label>
								<div class="col-sm-4">
							...
							<div class="form-group">
								<label for="basicareaid" class="control-label col-sm-2">Exam area</label>
								<div class="col-sm-4">
									<select class="form-control" id="basicareaid" name="args[basicareaid]" needle="needle" msg="You must choose the test area.">
