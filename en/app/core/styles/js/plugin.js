...
jQuery.extend({'zoombox':(function(){
	...
	return {'show':function(type,obj,url){
			switch(type)
			{
				...
				var cnt = "<div class=\"modal-dialog\" role=\"document\" style=\"width:550px;\"><div class=\"modal-content\"><div class=\"modal-header\"><button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\" autocomplete=\"off\"><span aria-hidden=\"true\">×</span></button><h4 class=\"modal-title\" id=\"myModalLabel\">Operation confirmation</h4></div><div class=\"modal-body\"><p class=\"text-danger\" style=\"font-size:1.2em;\">"+msg+"</p></div><div class=\"modal-footer\"><button class=\"btn btn-primary\" onclick=\"javascript:submitAjax({'url':'"+url+"'});\">Confirm</button><button class=\"btn\" onclick=\"javascript:$.zoombox.hide();\">Cancel</button></div></div></div>";
				m.html(cnt);
...
'loginbox':(function(){
	...
	return {'show':function(){
			lcnt = "<div class=\"modal-dialog\" role=\"document\"><div class=\"modal-content\"><div class=\"modal-header\"><button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\" autocomplete=\"off\"><span aria-hidden=\"true\">×</span></button><h4 class=\"modal-title\" id=\"myModalLabel\">User Login</h4></div><div class=\"modal-body\"><form class=\"form-horizontal\" id=\"peloginform\" action=\"index.php?user-app-login\" style=\"padding-top:20px;\"><div class=\"form-group\"><label class=\"col-sm-3 control-label\" for=\"inputEmail\">Username：</label><div class=\"col-sm-7\"><input class=\"form-control\" name=\"args[username]\" type=\"text\" needle=\"needle\" msg=\"Please enter the correct username!\"/></div></div><div class=\"form-group\" style=\"margin-top:10px;\"><label class=\"col-sm-3 control-label\" for=\"inputPassword\">Password：</label><div class=\"col-sm-7\"><input class=\"form-control\" needle=\"needle\" msg=\"Please enter the correct password!\" name=\"args[userpassword]\" type=\"password\" /><input type=\"hidden\" value=\"1\" name=\"userlogin\"/></div></div></form></div><div class=\"modal-footer\"><button class=\"btn btn-primary\" type=\"button\" onclick=\"javascript:$('#peloginform').submit();\">Login</button><button aria-hidden=\"true\" class=\"btn\" data-dismiss=\"modal\">Cancel</button></div></div></div>";
			l.html(lcnt);
