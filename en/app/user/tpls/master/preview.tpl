				...
				<div class="box itembox">
					<h4 class="title" style="padding:10px;">
						...
						<span class="pull-right">
							<a class="btn btn-primary dropdown-toggle" href="#" data-toggle="dropdown">Model list<strong class="caret"></strong></a>
							<ul class="dropdown-menu">
								<li>
									<a href="index.php?user-master-module">Model list</a>
								</li>
								<!-- <li class="divider"></li>
								<li>
