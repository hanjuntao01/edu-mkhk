...
<div class="container-fluid">
 ...
 $cid++; ?>
				<div class="col-xs-3">
					<a style="height:256px;overflow:hidden" href="index.php?course-app-course&csid=<?php echo $course['csid']; ?>" class="thumbnail">
						<img src="../<?php echo $course['csthumb']; ?>" alt="" style="overflow:hidden">
					</a>
