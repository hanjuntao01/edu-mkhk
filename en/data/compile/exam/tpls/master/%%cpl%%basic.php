...
<?php } ?>
				...
				<div class="box itembox" style="padding-top:10px;margin-bottom:0px;">
					<h4 class="title" style="padding:10px;">
						...
						<a class="btn btn-primary pull-right" href="index.php?exam-master-basic-add">Add exam room</a>
					</h4>
 ...
 -->									<td>
									...
									<td>
										<div class="btn-group">
											<!-- <a class="btn" href="index.php?exam-master-basic-offpaper&page=<?php echo $this->tpl_var['page']; ?>&basicid=<?php echo $basic['basicid']; ?><?php echo $this->tpl_var['u']; ?>" title="Examination scheduling"><em class="glyphicon glyphglyphicon glyphicon-wrench"></em></a> -->
											<a class="btn" href="index.php?exam-master-basic-setexamrange&page=<?php echo $this->tpl_var['page']; ?>&basicid=<?php echo $basic['basicid']; ?><?php echo $this->tpl_var['u']; ?>" title="Examination scope"><em class="glyphicon glyphglyphicon glyphicon-cog"></em></a>
											<a class="btn" href="index.php?exam-master-basic-modifybasic&page=<?php echo $this->tpl_var['page']; ?>&basicid=<?php echo $basic['basicid']; ?><?php echo $this->tpl_var['u']; ?>" title="Modify"><em class="glyphicon glyphglyphicon glyphicon-edit"></em></a>
											<a class="btn confirm" href="index.php?exam-master-basic-delbasic&basicid=<?php echo $basic['basicid']; ?>&page=<?php echo $this->tpl_var['page']; ?><?php echo $this->tpl_var['u']; ?>" title="Delete"><em class="glyphicon glyphglyphicon glyphicon-remove"></em></a>
										</div>
									</td>
						        </tr>
						        <?php } ?>
