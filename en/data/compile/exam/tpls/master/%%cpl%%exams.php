					...
					<h4 class="title" style="padding:10px;">
						...
						<span class="pull-right">
							...
							<ul class="dropdown-menu">
								...
								<li><a href="index.php?<?php echo $this->tpl_var['_app']; ?>-master-exams-selfpage&page=<?php echo $this->tpl_var['page']; ?><?php echo $this->tpl_var['u']; ?>">Manual test paper</a></li>
							...
							<tr>
								...
								<td>
									<select name="search[examtype]" class="form-control">
										<option value="0">Umlimited</option>
										<!-- <option value="1"<?php if($this->tpl_var['search']['examtype'] == 1){ ?> selected<?php } ?>>随机抽题</option> -->
										<option value="2"<?php if($this->tpl_var['search']['examtype'] == 2){ ?> selected<?php } ?>>Manual test paper</option>
					        ...
					        <tr>
								...
								<td>
									<div class="btn-group">
			                    		...
			                    		<a class="btn" target="_blank" href="index.php?<?php echo $this->tpl_var['_app']; ?>-master-exams-preview&examid=<?php echo $exam['examid']; ?><?php echo $this->tpl_var['u']; ?>" title="Check the papers"><em class="glyphicon glyphicon-list-alt"></em></a>
			                    		<?php } ?>
			                    		<?php if($exam['examtype'] == 3){ ?>
			                    		<a class="btn ajax" href="index.php?<?php echo $this->tpl_var['_app']; ?>-master-exams-outcsv&page=<?php echo $this->tpl_var['page']; ?>&examid=<?php echo $exam['examid']; ?><?php echo $this->tpl_var['u']; ?>" title="Download csv"><em class="glyphicon glyphicon-download-alt"></em></a>
			                    		<?php } ?>
			                    		<a class="btn" href="index.php?<?php echo $this->tpl_var['_app']; ?>-master-exams-modify&page=<?php echo $this->tpl_var['page']; ?>&examid=<?php echo $exam['examid']; ?><?php echo $this->tpl_var['u']; ?>" title="Modify"><em class="glyphicon glyphicon-edit"></em></a>
										<a class="btn confirm" href="index.php?<?php echo $this->tpl_var['_app']; ?>-master-exams-del&page=<?php echo $this->tpl_var['page']; ?>&examid=<?php echo $exam['examid']; ?><?php echo $this->tpl_var['u']; ?>" title="Delete"><em class="glyphicon glyphicon-remove"></em></a>
			                    	</div>
								</td>
					        </tr>
					        <?php } ?>
