...
<?php } ?>
				<div class="box itembox" style="margin-bottom:0px;border-bottom:1px solid #CCCCCC;">
					<div class="col-xs-12">
						<ol class="breadcrumb">
							...
							<li><a href="index.php?<?php echo $this->tpl_var['_app']; ?>-teach-basic&page=<?php echo $this->tpl_var['page']; ?><?php echo $this->tpl_var['u']; ?>">Examination room management</a></li>
							<li class="active">Examination scope</li>
						</ol>
					</div>
				</div>
				<div class="box itembox" style="padding-top:10px;margin-bottom:0px;">
			        ...
			        <form action="?exam-teach-basic-setexamrange" method="post" class="form-horizontal">
						...
						<div class="form-group">
							<label class="control-label col-sm-2">Select chapter：<input type="checkbox" onclick="javascript:$('.section:checkbox').prop('checked',$(this).is(':checked'));"> </label>
						</div>
						<?php $sid = 0;
 ...
 $tid++; ?>
						...
						<div class="form-group">
							<label for="basicexam_self" class="control-label col-sm-2">Bind the real examination paper：</label>
							<div class="col-sm-9 form-inline">
								<input size="50" class="form-control" type="text" id="basicexam_self" name="args[basicexam][self]" needle="needle" msg="You must fill in at least one test paper." value="<?php echo $this->tpl_var['basic']['basicexam']['self']; ?>" /> <a class="selfmodal btn btn-primary" href="javascript:;" data-target="#modal" url="index.php?exam-teach-exams-selectexams&search[subjectid]=<?php echo $this->tpl_var['basic']['basicsubjectid']; ?>&exams={basicexam_self}&useframe=1&target=basicexam_self" valuefrom="basicexam_self">Select papers</a>
								<span class="help-block">Please check the paper ID in the examination paper management office, fill in the digital ID here, please use the English comma (,) separated. Blank or fill 0 will not be able to carry out the examination.</span>
							</div>
						</div>
					<!--	<div class="form-group">
