...
<?php } ?>
 ...
 $qnid++; ?>
					...
					<table class="table table-hover table-bordered">
						<tr class="info">
							<td style="width:80px;">Questions <?php echo $tid; ?></td>
							<td>&nbsp;</td>
						</tr>
						<tr>
							<td>Title：</td>
						...
						<tr>
							<td colspan="2" class="form-inline">【Given Marks】<input size="8" class="form-control" type="text" needle="needle" msg="Given Marks" name="score[<?php echo $question['questionid']; ?>]" value=""> <span>Total marks are <?php echo $this->tpl_var['sessionvars']['ehsetting']['examsetting']['questype'][$quest['questid']]['score']; ?> points and marks  could be a mulitple of 0.5</span></td>
						</tr>
					</table>
					<?php } ?>
					<?php $qrid = 0;
 ...
 $cqid++; ?>
								<table class="table" width="96%">
									<tr class="info">
										<td style="width:80px;">Questions <?php echo $cqid; ?></td>
										<td>&nbsp;</td>
									</tr>
									<tr>
										<td>标题：</td>
