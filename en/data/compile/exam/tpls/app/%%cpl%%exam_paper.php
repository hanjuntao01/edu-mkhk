...
<div class="container-fluid" id="questioncontent">
 ...
 $sid++; ?>
					...
					<div class="toolbar">
						<?php if($qcid > 1){ ?>
						<a class="btn btn-default" onclick="javascript:gotoindexquestion(<?php echo $qcid - 2;; ?>);"><span class="glyphicon glyphicon-chevron-left"></span>Previous question</a>
						<?php } ?>
						<?php if($qcid < $qmid){ ?>
						<a class="pull-right btn btn-primary" onclick="javascript:gotoindexquestion(<?php echo $qcid; ?>);">Next question<span class="glyphicon glyphicon-chevron-right"></span></a>
						<?php } ?>
					</div>
				</div>
				<?php } ?>
 ...
 $did++; ?>
				...
				<div class="box itembox paperexamcontent" id="questions_<?php echo $data['questionid']; ?>" rel="<?php echo $quest; ?>">
					<h4 class="title">the <?php echo $tid; ?> Questions</h4>
					<div class="choice">
 ...
 $sid++; ?>
				...
				<h3 class="text-center">
					...
					<a class="btn btn-primary" style="font-size:1em;width:270px;" href="#submodal" role="button" data-toggle="modal">Submit</a>
				</h3>
			</form>
		</div>
	</div>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<p>You answered <span class="yesdonumber">0</span> <span class="qtype">questions</span> out of totally <span class="allquestionnumber">50</span> questions, do you want to hand your exams in?</p>
			</div>
			<div class="modal-footer">
				<button type="button" onclick="javascript:submitPaper();" class="btn btn-primary">Confirm</button>
				<button aria-hidden="true" class="btn" type="button" data-dismiss="modal">Check again</button>
			</div>
		</div>
	</div>
</div>
...
$(document).ready(function(){
	...
	if($('#questionindex .btn-primary').length>1){
		$('.qtype').html('questions');
	}else{
		$('.qtype').html('question');
	}
});
