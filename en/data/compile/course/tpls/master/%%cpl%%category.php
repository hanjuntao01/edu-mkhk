...
<?php } ?>
				...
				<div class="box itembox" style="padding-top:10px;margin-bottom:0px;">
					<h4 class="title" style="padding:10px;">
						...
						<span class="dropdown pull-right">
							<a class="btn btn-primary" href="#" data-toggle="dropdown">Add category <strong class="caret"></strong></a>
							<ul class="dropdown-menu">
								<li><a href="index.php?<?php echo $this->tpl_var['_app']; ?>-master-category-add&parent=<?php echo $this->tpl_var['parent']; ?>">Add category</a></li>
					...
					<h4><?php if($this->tpl_var['parent']){ ?><?php echo $this->tpl_var['categories'][$this->tpl_var['parent']]['catname']; ?><?php } else { ?>Top Category<?php } ?></h4>
 ...
 $sid++; ?>
						            ...
						            <label class="radio-inline">
						            	<button class="btn btn-primary" type="submit">Change sort</button>
						            </label>
