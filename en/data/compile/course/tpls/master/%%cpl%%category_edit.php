			...
			<div class="col-xs-10" id="datacontent">
				<div class="box itembox" style="margin-bottom:0px;border-bottom:1px solid #CCCCCC;">
					<div class="col-xs-12">
						<ol class="breadcrumb">
							...
							<li><a href="index.php?<?php echo $this->tpl_var['_app']; ?>-master-category">Category management</a></li>
				...
				<div class="box itembox" style="padding-top:10px;margin-bottom:0px;">
					<h4 class="title" style="padding:10px;">
						Modify category
						<a class="btn btn-primary pull-right" href="index.php?<?php echo $this->tpl_var['_app']; ?>-master-category&parent=<?php echo $this->tpl_var['parent']; ?>">Category list</a>
					</h4>
					<form action="index.php?<?php echo $this->tpl_var['_app']; ?>-master-category-edit" method="post" class="form-horizontal">
						<fieldset>
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input class="form-control" type="text" id="input1" name="args[catname]" value="<?php echo $this->tpl_var['category']['catname']; ?>" datatype="userName" needle="needle" msg="You must enter the name of the Chinese and English characters.">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<label class="radio-inline">
						          		<input type="radio" class="input-text" name="args[catinmenu]" value="1"<?php if($this->tpl_var['category']['catinmenu']){ ?> checked<?php } ?>/> no
						          	</label>
						          	<label class="radio-inline">
						          		<input type="radio" class="input-text" name="args[catinmenu]" value="0"<?php if(!$this->tpl_var['category']['catinmenu']){ ?> checked<?php } ?>/> yes
						          	</label>
							    		...
							    		<div class="qq-uploader-selector" style="width:30%" qq-drop-area-text="Drag the picture to upload here" style="clear:both;">
							            	<div class="qq-upload-button-selector" style="clear:both;">
									            ...
									            <ul class="qq-upload-list-selector list-unstyled" aria-live="polite" aria-relevant="additions removals" style="clear:both;">
										            <li class="text-center">
										                <div class="thumbnail">
															<img class="qq-thumbnail-selector" src="<?php if($this->tpl_var['category']['catimg']){ ?><?php echo $this->tpl_var['category']['catimg']; ?><?php } else { ?>app/core/styles/images/noimage.gif<?php } ?>" alt="Click to upload a new picture">
