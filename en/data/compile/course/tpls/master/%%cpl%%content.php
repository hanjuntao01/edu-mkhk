...
<?php } ?>
				<div class="box itembox" style="margin-bottom:0px;border-bottom:1px solid #CCCCCC;">
					<div class="col-xs-12">
						<ol class="breadcrumb">
							...
							<li><a href="index.php?<?php echo $this->tpl_var['_app']; ?>-master-contents">Courseware management</a></li>
							<li class="active"><?php echo $this->tpl_var['categories'][$this->tpl_var['catid']]['catname']; ?></li>
							<?php } else { ?>
							<li class="active">Courseware management</li>
							<?php } ?>
						</ol>
					</div>
				</div>
				<div class="box itembox" style="padding-top:10px;margin-bottom:0px;">
					<h4 class="title" style="padding:10px;">
						...
						<a class="btn btn-primary pull-right" href="index.php?course-master-contents-add&courseid=<?php echo $this->tpl_var['course']['csid']; ?>&page=<?php echo $this->tpl_var['page']; ?>">Add courseware</a>
					</h4>
					<h4><?php if($this->tpl_var['course']){ ?><?php echo $this->tpl_var['course']['cstitle']; ?><?php } else { ?>All courseware<?php } ?></h4>
