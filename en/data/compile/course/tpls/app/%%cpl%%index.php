...
<div class="container-fluid">
 ...
 $cid++; ?>
				<div class="col-xs-3">
					<a style="height:256px;overflow:hidden" href="index.php?course-app-course&csid=<?php echo $content['csid']; ?>" class="thumbnail">
						<img src="../<?php echo $content['csthumb']; ?>" alt="" style="overflow:hidden">
					</a>
